...
Splunk.Module.TA_Windows_FTR= $.klass(Splunk.Module, {
    ...
    NOT_WINDOWS_WARN: '<p class="popupText">Splunk has detected that the server operating system is not Windows.</p><p class="popupText">The Splunk Add-on for Microsoft Windows 
    can only be installed and configured on Windows operating systems.</p><p class="popupText">Please click on Manage Apps to disable the Splunk Add-on for Microsoft Windows and restart Splunk.</p>', 
